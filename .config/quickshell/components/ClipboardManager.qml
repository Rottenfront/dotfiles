                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        color: wipeMA.containsMouse
                            ? Theme.error_container : "transparent"
                        border.color: wipeMA.containsMouse
                            ? Theme.error : ColorsModule.Colors.outline_variant
                        border.width: 1
                        Layout.alignment: Qt.AlignVCenter
                    ...
                    Rectangle {
                        ...
                        color: closeHov.containsMouse
                            ? Theme.surface_container_high : "transparent"
                        Layout.alignment: Qt.AlignVCenter
                ...
                ListView {
                    ...
                    delegate: Item {
                        ...
                        Rectangle {
                            ...
                            radius: 10
                            clip: true
                            color: isFoc ? Theme.surface_container_high
                                 : isHov ? Theme.surface_container
                                 :         "transparent"
                            border.color: isFoc ? Theme.primary : "transparent"
                    ...
                    Column {
                        ...
                        Text {
                            ...
                            color: Theme.on_surface_variant; opacity: 0.3
                        }
                        Text {
                            anchors.horizontalCenter: parent.horizontalCenter
                            text: root.clipAllEntries.length === 0 ? "No clipboard history" : "No matches"
                            font { pixelSize: 13; family: "Noto Sans" }
                            color: Theme.on_surface_variant; opacity: 0.55
                        }
                    }
                }
            ...
            Item {
                ...
                RowLayout {
                    ...
                    Text {
                        ...
                        color: Theme.on_surface_variant; opacity: 0.65
                    }
                    ...
                    Text {
                        text: root.currentTab === 0
                            ...
                            : "↵ copy  ·  Esc close"
                        font { pixelSize: 11; family: "Noto Sans" }
                        color: Theme.on_surface_variant; opacity: 0.35
                    }
                }
            }
        }

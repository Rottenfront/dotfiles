...
Rectangle {
    ...
    Item {
        ...
        Repeater {
            ...
            Rectangle {
                ...
                color: index % 3 === 0 ? Theme.primary : ColorsModule.Colors.on_surface_variant
        ...
        Rectangle {
            ...
            gradient: Gradient {
                ...
                GradientStop { position: 0.8; color: Qt.darker(Theme.primary, 1.2) }
            }
        ...
        Rectangle {
            ...
            gradient: Gradient {
                GradientStop { position: 0.0; color: Theme.primary }
                GradientStop { position: 0.8; color: Qt.darker(Theme.primary, 1.1) }
            }
    ...
    Rectangle {
        ...
        color: "transparent"
        border.color: Theme.surface_tint
        border.width: 1
        opacity: 0.08
    }

        ...
        ColumnLayout {
                    ...
                    Repeater {
                        ...
                        Button {
                            ...
                            background: Rectangle {
                                ...
                                color: index === 1
                                    ? (parent.hovered ? Theme.primary_container : ColorsModule.Colors.primary)
                                    : (parent.hovered ? Theme.surface_container_highest : "transparent")
            ...
            RowLayout {
                ...
                Button {
                    ...
                    background: Rectangle {
                        radius: 4
                        color: parent.hovered ? Theme.surface_container_highest : "transparent"
            ...
            ColumnLayout {
                ...
                Slider {
                    ...
                    handle: Rectangle {
                        ...
                        implicitHeight: 12
                        radius: 6
                        color: progressSlider.pressed ? Theme.primary_fixed : ColorsModule.Colors.primary

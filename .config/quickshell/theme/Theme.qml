...
QtObject {
    ...
    readonly property color inverse_primary: "#006a6a"
    ...
    readonly property color on_primary_fixed_variant: "#004f50"
    ...
    readonly property color on_secondary_fixed_variant: "#324b4b"
    ...
    readonly property color on_tertiary_fixed_variant: "#334863"

    readonly property color outline: "#889392"

    readonly property color outline_variant: "#3f4948"

    readonly property color primary: "#80d5d4"

    readonly property color primary_container: "#004f50"

    readonly property color primary_fixed: "#9cf1f0"

    readonly property color primary_fixed_dim: "#80d5d4"
    ...
    readonly property color secondary_fixed_dim: "#b0cccb"

    readonly property color shadow: "#000000"

    readonly property color source_color: "#000101"
    ...
    readonly property color surface_tint: "#80d5d4"

    readonly property color surface_variant: "#3f4948"

    readonly property color tertiary: "#b3c8e8"

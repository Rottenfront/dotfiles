...
Item {
    ...
    Rectangle {
        anchors.fill: parent
        color: root.menuOpen ? Qt.rgba(0/255,0/255,0/255,0.4) : "transparent"
        visible: true
            ...
            Item {
                ...
                Row {
                    ...
                    Row {
                        ...
                        Text { text:"SYSTEM";  font.weight: Font.Bold;font.family: "Cascadia Code"; font.pixelSize:11; font.letterSpacing:3.5; color:root.inkStrong }
                        Rectangle { width:24; height:1; color:root.inkSoft; anchors.verticalCenter:parent.verticalCenter }
                        Text { text:"システム";  font.weight: Font.Bold;font.family: "Cascadia Code"; font.pixelSize:10; font.letterSpacing:2; color:root.inkSoft }
                    }
                    ...
                    Row {
                        ...
                        Item {
                            ...
                            Text {
                                ...
                                text: root.clockStr + " · " + root.apps.length + " APPS · "
                                 font.weight: Font.Bold;font.family: "Cascadia Code"; font.pixelSize:9; font.letterSpacing:1.5; color:root.inkSoft; y:2
                        ...
                        Text { text:"SESSION 0471";  font.weight: Font.Bold;font.family: "Cascadia Code"; font.pixelSize:9; font.letterSpacing:2.5; color:root.inkSoft }
                    }
                }
                    ...
                    Column {
                            ...
                            delegate: Item {
                                ...
                                Row {
                                    ...
                                    Text {
                                        ...
                                        text: root.catLabels[modelData] || modelData.toUpperCase()
                                         font.weight: Font.Bold;font.family: "Cascadia Code"; font.pixelSize:10; font.letterSpacing:2
                                ...
                                Text {
                                    ...
                                    text: root.apps.filter(function(a){ return modelData==="all"||a.cat===modelData }).length.toString().padStart(2,"0")
                                     font.weight: Font.Bold;font.family: "Cascadia Code"; font.pixelSize:9; font.letterSpacing:1
                        ...
                        Item {
                            ...
                            Column {
                                ...
                                spacing:4
                                Text { text:root.filteredApps.length+"/"+root.apps.length+" NODES";  font.weight: Font.Bold;font.family: "Cascadia Code"; font.pixelSize:8; font.letterSpacing:2; color:root.inkSoft; opacity:0.6 }
                                Rectangle {
                    ...
                    Column {
                        ...
                        Item {
                            ...
                            Row {
                                ...
                                spacing:10
                                Text { anchors.verticalCenter:parent.verticalCenter; text:"▸";  font.weight: Font.Bold;font.family: "Cascadia Code"; font.pixelSize:12; color:root.accent }
                                FocusScope {
                                    ...
                                    TextInput {
                                        ...
                                        verticalAlignment: TextInput.AlignVCenter
                                         font.weight: Font.Bold;font.family: "Cascadia Code"; font.pixelSize:13; font.letterSpacing:0.5
                                        ...
                                        Text {
                                            ...
                                            text:"search application..."
                                             font.weight: Font.Medium;font.family: "Cascadia Code"; font.pixelSize:13; font.italic:true
                        ...
                        ListView {
                            ...
                            delegate: Item {
                                ...
                                Row {
                                    ...
                                    Text {
                                        anchors.verticalCenter:parent.verticalCenter
                                        text:modelData.id; width:22;  font.weight: Font.Bold;font.family: "Cascadia Code"; font.pixelSize:9; font.letterSpacing:1.5
                                    ...
                                    Rectangle {
                                        ...
                                        Text {
                                            anchors.centerIn:parent; text:modelData.icon;  font.weight: Font.Bold;font.family: "Cascadia Code"; font.pixelSize:12
                                    ...
                                    Column {
                                        ...
                                        Text {
                                            text:modelData.name;  font.weight: Font.Bold;font.family: "Cascadia Code"; font.pixelSize:12; font.letterSpacing:1.2
                                            color: appMA.containsMouse||appDelegate.isFocused ? Qt.rgba(214/255,207/255,181/255,1) : root.ink
                                            Behavior on color { ColorAnimation { duration:120 } }
                                        }
                                        Text {
                                            text:modelData.meta;  font.weight: Font.Bold;font.family: "Cascadia Code"; font.pixelSize:9; font.letterSpacing:1.5
                                            color: appMA.containsMouse||appDelegate.isFocused ? Qt.rgba(214/255,207/255,181/255,0.5) : root.inkSoft
                                            Behavior on color { ColorAnimation { duration:120 } }
                                        }
                                    }
                                    ...
                                    Text {
                                        ...
                                        text:(root.catLabels[modelData.cat]||modelData.cat).toUpperCase()
                                         font.weight: Font.Bold;font.family: "Cascadia Code"; font.pixelSize:9; font.letterSpacing:2
                                        color: appMA.containsMouse||appDelegate.isFocused ? Qt.rgba(214/255,207/255,181/255,0.4) : root.inkSoft
                                        Behavior on color { ColorAnimation { duration:120 } }
                                    }
                                    Text {
                                        anchors.verticalCenter:parent.verticalCenter
                                        text:"▸";  font.weight: Font.Bold;font.family: "Cascadia Code"; font.pixelSize:14; color:root.accent
                            ...
                            Item {
                                ...
                                Text { anchors.centerIn:parent; text:"▸ NO RESULTS";  font.weight: Font.Bold;font.family: "Cascadia Code"; font.pixelSize:10; font.letterSpacing:3; color:root.inkSoft; opacity:0.5 }
                            }
                        }
                    }
                }
            ...
            Item {
                ...
                Row {
                    ...
                    Row {
                        ...
                        Repeater {
                            model:[
                                {l:"TERMINAL", cmd:"ghostty"},
                                {l:"FILES",    cmd:"ghostty -e yazi"},
                            ...
                            delegate: Item {
                                ...
                                Text {
                                    ...
                                    text:modelData.l;  font.weight: Font.Bold;font.family: "Cascadia Code"; font.pixelSize:9; font.letterSpacing:2.5
                        ...
                        Repeater {
                            ...
                            Row {
                                ...
                                Rectangle {
                                    ...
                                    Text { id:kbdT; anchors.centerIn:parent; text:modelData[0];  font.weight: Font.Bold;font.family: "Cascadia Code"; font.pixelSize:9; font.letterSpacing:1; color:root.ink }
                                }
                                Text { text:modelData[1]; anchors.verticalCenter:parent.verticalCenter;  font.weight: Font.Bold;font.family: "Cascadia Code"; font.pixelSize:9; font.letterSpacing:2; color:root.inkSoft }
                            }
                        }
                    }
                }

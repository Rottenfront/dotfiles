                ...
                Item {
                    ...
                    Column { spacing:2
                        Row { spacing:5
                            ...
                            Text{text:"WALLPAPER SELECT";font.family:"Cascadia Code";font.weight:Font.Bold;font.pixelSize:12;font.letterSpacing:2;color:"#463f2e"}
                        }
                        Text{text:"NODE · "+root.activeMonitor;font.family:"Cascadia Code";font.weight:Font.Bold;font.pixelSize:12;font.letterSpacing:2;color:"#463f2e"}
                    }
                }
                Item {
                    anchors{top:parent.top;right:parent.right;topMargin:28;rightMargin:30}
                    z:5; opacity:parent.uiOp
                    Text{text:root.clockFull;font.family:"Cascadia Code";font.weight:Font.Bold;font.pixelSize:12;font.letterSpacing:2;color:"#463f2e"}
                }
                Item {
                    anchors{bottom:parent.bottom;left:parent.left;bottomMargin:28;leftMargin:30}
                    z:5; opacity:parent.uiOp
                    Text{text:"↑↓ / SCROLL  NAVIGATE  ·  ESC  QUIT";font.family:"Cascadia Code";font.weight:Font.Bold;font.pixelSize:12;font.letterSpacing:2;color:"#463f2e"}
                }
                    ...
                    Rectangle {
                        ...
                        Column {
                            ...
                            Text {
                                ...
                                font.family:"Cascadia Code";font.weight:Font.Bold;font.pixelSize:16;font.letterSpacing:3
                            ...
                            Row {
                                ...
                                Item { width:162; height:42
                                    ...
                                    Text { anchors.centerIn:parent
                                        text:"THIS SCREEN"
                                        font.family:"Cascadia Code";font.weight:Font.Bold;font.pixelSize:16;font.letterSpacing:2
                            ...
                            Rectangle {
                                ...
                                Rectangle {
                                    ...
                                    Text {
                                        ...
                                        font.family: "Cascadia Code";font.weight:Font.Bold
                                        font.pixelSize: 8
                                        color: "#c8b89a"
                                    }
                                }

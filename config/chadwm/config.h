...
static const char *fonts[]          = {"Caskaydia Cove NF:size=12"};
...
static const Key keys[] = {
    ...
    { MODKEY|ShiftMask, XK_b, spawn, SHCMD("microsoft-edge-stable")},
    { MODKEY|ShiftMask, XK_s, spawn, SHCMD("scrot -z -s '/home/rtfr/Screenshots/%d%b-%H%M.png' -e 'xclip -selection clipboard -t image/png $f'")},
